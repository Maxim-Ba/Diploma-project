export default class Validate {
  constructor(formElement, button, warningField) {
    ...
    this._inputFieldInputCheckField = this._inputFieldInputCheckField.bind(this);
    this.fieldInput.addEventListener('input', this._inputFieldInputCheckField);

  };
  _inputFieldInputCheckField() {
